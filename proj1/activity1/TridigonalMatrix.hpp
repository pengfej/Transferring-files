#ifndef __Math8650_TridigonalMatrix_HPP__
#define __Math8650_TridigonalMatrix_HPP__
...
public:
  ...
  TridigonalMatrix(std::size_t p, std::size_t q, const double val = 0.0);
  virtual ~TridigonalMatrix();
  ...
  friend std::ostream& operator<<(std::ostream& out, const TridigonalMatrix& mat)
  {
...
#endif /** __Math8650_TridigonalMatrix_HPP__ */
