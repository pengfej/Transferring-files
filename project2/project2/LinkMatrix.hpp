#ifndef __Math8650_LinkMatrix_HPP__
#define __Math8650_LinkMatrix_HPP__
...
public:
  ...
  LinkMatrix(std::size_t p, std::size_t q) : m_rows(p), m_cols(q), m_is_allocated(false) {}
  ...
  friend std::ostream& operator<<(std::ostream& out, const LinkMatrix& mat)
  {
...
#endif /** __Math8650_LinkMatrix_HPP__ */
